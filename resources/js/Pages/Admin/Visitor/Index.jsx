...
export default function Index({ visitors }) {
    const [params, setParams] = useState(visitors.filtered);
    ...
    useEffect(() => {
        ...
        timeoutRef.current = setTimeout(() => {
            router.visit(route("admin.visitor.index"), {
                data: {
                    ...pickBy(
                        params,
        ...
        <Card className="bg-white border-primary/20">
            <CardHeader>
                <div className="flex items-center justify-between">
                    <div>
                        <CardTitle className="mb-2">Visitors</CardTitle>
                        <CardDescription>
                            Recent Visitor from your system
                        </CardDescription>
                    </div>
                </div>
            </CardHeader>
            <CardContent>
                ...
                <ul className="flex items-center gap-x-px">
                    {visitors.meta.links.map((link, index) => (
